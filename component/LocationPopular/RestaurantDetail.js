            ...
            <View style={styles.coontainer}>
                ...
                <View style={styles.block_title}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        <Text style={{ fontSize: 12, fontWeight: '600' }}><Text style={{ color: '#333333', fontWeight: '600', fontFamily: 'sf-ui-display-bold-58646a511e3d9' }}>Gía :</Text>  20.000đ -- 400.000đ</Text>
                        <CustomBar />
                    </View>
                </View>
                ...
                <View style={{ flexDirection: 'row',justifyContent:'space-evenly' }}>
                    ...
                    <View style={styles.block_image}>
                        ...
                        <View>
                            <Image style={{ position: 'absolute', top:scale(-60), left: '40%', width:scale(17), height: verticalScale(17) }} source={require('../../assets/sum.png')} />
                        </View>
